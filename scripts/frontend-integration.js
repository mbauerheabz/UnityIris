 ...
 * This file demonstrates how to integrate Unityiris with a web frontend
 */

// For React/Vue/Angular applications
export class UnityirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new UnityirisClient(provider, contractAddress);
